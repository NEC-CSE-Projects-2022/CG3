...
- **22471A05G1 —** **Katari Thanmai** ( [LinkedIn](https://www.linkedin.com/in/katari-thanmai-b96863276) )  Work Done: ML/DL model implementation (RF, FNN, LSTM, GRU), training, tuning, evaluation.
- **22471A05J6 —** **Sonti Vineela** ( [LinkedIn](https://www.linkedin.com/in/vineela-sonti-684375324) )  Work Done: Model comparison, result analysis, visualization, documentation.
